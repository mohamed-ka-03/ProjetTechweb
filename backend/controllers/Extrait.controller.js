  ...
  exports.traiterDemandepdf = async (req, res) => {
    ...
    try {
      ...
      html = html.replace('{{nomDemandeur}}', demande.nomDemandeur)
                 ...
                 .replace('{{dateNaissance}}', extraitExistante.dateNaissance)
                 .replace('{{lieuNaissance}}', extraitExistante.lieuNaissance)
                 .replace('{{nomPere}}', extraitExistante.nomPere)
                 .replace('{{prenomsPere}}', extraitExistante.prenomsPere)
                 .replace('{{nomMere}}', extraitExistante.nomMere)
                 .replace('{{prenomsMere}}', extraitExistante.prenomsMere)
                 .replace('{{sexe}}', extraitExistante.sexe)
                 .replace('{{numeroIdentification}}', demande.numeroIdentification)
                 .replace('{{cni}}', extraitExistante.cni)
                 .replace('{{dateDelivrance}}', extraitExistante.dateDelivrance)
                 .replace('{{lieuDelivrance}}', extraitExistante.lieuDelivrance)
                 .replace('{{signatureOfficierEtatCivil}}', extraitExistante.signatureOfficierEtatCivil);
